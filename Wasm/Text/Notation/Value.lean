...
scoped syntax "↑" term:max : wat_u32
scoped syntax num          : wat_u64
scoped syntax "↑" term:max : wat_u64

scoped syntax num : wat_s32
scoped syntax "↑" term:max : wat_s32
scoped syntax num : wat_s33
scoped syntax "↑" term:max : wat_s33
scoped syntax num : wat_s64
scoped syntax "↑" term:max : wat_s64

scoped syntax num          : wat_i32
scoped syntax "↑" term:max : wat_i32
scoped syntax wat_u32      : wat_i32
scoped syntax wat_s32      : wat_i32
scoped syntax num          : wat_i64
scoped syntax "↑" term:max : wat_i64
...
macro_rules
| `(>>wat_u32| $x:num<<)   => `(Unsigned.ofNat (n:=32) $x)
| `(>>wat_u32| ↑$e:term<<) => `($e)
| `(>>wat_u64| $x:num<<)   => `(Unsigned.ofNat (n:=64) $x)
| `(>>wat_u64| ↑$e:term<<) => `($e)

| `(>>wat_s32| $x:num<<)   => `(Signed.ofNat   (n:=32) $x)
| `(>>wat_s32| ↑$e:term<<) => `($e)
| `(>>wat_s33| $x:num<<)   => `(Signed.ofNat   (n:=33) $x)
| `(>>wat_s33| ↑$e:term<<) => `($e)
| `(>>wat_s64| $x:num<<)   => `(Signed.ofNat   (n:=64) $x)
| `(>>wat_s64| ↑$e:term<<) => `($e)

| `(>>wat_i32| $x:num<<)     => `(Unsigned.ofNat (n:=32) $x)
| `(>>wat_i32| ↑$e:term<<)   => `($e)
| `(>>wat_i32| $x:wat_u32<<) => `(>>wat_u32| $x<<)
| `(>>wat_i32| $x:wat_s32<<) => `(>>wat_s32| $x<<)
| `(>>wat_i64| $x:num<<)     => `(Unsigned.ofNat (n:=64) $x)
| `(>>wat_i64| ↑$e:term<<)   => `($e)
...
scoped syntax "↑" term:max : wat_ident
...
macro_rules
| `(>>wat_ident_str| $id:ident<<) => return Lean.Syntax.mkStrLit id.getId.toString
| `(>>wat_ident| $id:ident<<) => `(Ident.mk >>wat_ident_str| $id<< sorry sorry)
| `(>>wat_ident| ↑$e<<) => `($e)
...
scoped syntax "↑" term:max : wat_value
